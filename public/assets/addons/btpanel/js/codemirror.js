(function(c, d) {
    typeof exports === "object" && typeof module !== "undefined" ? module.exports = d() : typeof define === "function" && define.amd ? define(d) : (c.CodeMirror = d())
}(this, (function() {
    ...
    var ie = hE || /Android|webOS|BlackBerry|Opera Mini|Opera Mobi|IEMobile/i.test(iP);
    ...
    function h0(a) {
        return /\w/.test(a) || a > "\x80" && (a.toUpperCase() != a.toLowerCase() || mu.test(a))
    }
    function mo(a, b) {
        if (!b) {
            return h0(a)
    ...
    var ky = /[\u0300-\u036f\u0483-\u0489\u0591-\u05bd\u05bf\u05c1\u05c2\u05c4\u05c5\u05c7\u0610-\u061a\u064b-\u065e\u0670\u06d6-\u06dc\u06de-\u06e4\u06e7\u06e8\u06ea-\u06ed\u0711\u0730-\u074a\u07a6-\u07b0\u07eb-\u07f3\u0816-\u0819\u081b-\u0823\u0825-\u0827\u0829-\u082d\u0900-\u0902\u093c\u0941-\u0948\u094d\u0951-\u0955\u0962\u0963\u0981\u09bc\u09be\u09c1-\u09c4\u09cd\u09d7\u09e2\u09e3\u0a01\u0a02\u0a3c\u0a41\u0a42\u0a47\u0a48\u0a4b-\u0a4d\u0a51\u0a70\u0a71\u0a75\u0a81\u0a82\u0abc\u0ac1-\u0ac5\u0ac7\u0ac8\u0acd\u0ae2\u0ae3\u0b01\u0b3c\u0b3e\u0b3f\u0b41-\u0b44\u0b4d\u0b56\u0b57\u0b62\u0b63\u0b82\u0bbe\u0bc0\u0bcd\u0bd7\u0c3e-\u0c40\u0c46-\u0c48\u0c4a-\u0c4d\u0c55\u0c56\u0c62\u0c63\u0cbc\u0cbf\u0cc2\u0cc6\u0ccc\u0ccd\u0cd5\u0cd6\u0ce2\u0ce3\u0d3e\u0d41-\u0d44\u0d4d\u0d57\u0d62\u0d63\u0dca\u0dcf\u0dd2-\u0dd4\u0dd6\u0ddf\u0e31\u0e34-\u0e3a\u0e47-\u0e4e\u0eb1\u0eb4-\u0eb9\u0ebb\u0ebc\u0ec8-\u0ecd\u0f18\u0f19\u0f35\u0f37\u0f39\u0f71-\u0f7e\u0f80-\u0f84\u0f86\u0f87\u0f90-\u0f97\u0f99-\u0fbc\u0fc6\u102d-\u1030\u1032-\u1037\u1039\u103a\u103d\u103e\u1058\u1059\u105e-\u1060\u1071-\u1074\u1082\u1085\u1086\u108d\u109d\u135f\u1712-\u1714\u1732-\u1734\u1752\u1753\u1772\u1773\u17b7-\u17bd\u17c6\u17c9-\u17d3\u17dd\u180b-\u180d\u18a9\u1920-\u1922\u1927\u1928\u1932\u1939-\u193b\u1a17\u1a18\u1a56\u1a58-\u1a5e\u1a60\u1a62\u1a65-\u1a6c\u1a73-\u1a7c\u1a7f\u1b00-\u1b03\u1b34\u1b36-\u1b3a\u1b3c\u1b42\u1b6b-\u1b73\u1b80\u1b81\u1ba2-\u1ba5\u1ba8\u1ba9\u1c2c-\u1c33\u1c36\u1c37\u1cd0-\u1cd2\u1cd4-\u1ce0\u1ce2-\u1ce8\u1ced\u1dc0-\u1de6\u1dfd-\u1dff\u200c\u200d\u20d0-\u20f0\u2cef-\u2cf1\u2de0-\u2dff\u302a-\u302f\u3099\u309a\ua66f-\ua672\ua67c\ua67d\ua6f0\ua6f1\ua802\ua806\ua80b\ua825\ua826\ua8c4\ua8e0-\ua8f1\ua926-\ua92d\ua947-\ua951\ua980-\ua982\ua9b3\ua9b6-\ua9b9\ua9bc\uaa29-\uaa2e\uaa31\uaa32\uaa35\uaa36\uaa43\uaa4c\uaab0\uaab2-\uaab4\uaab7\uaab8\uaabe\uaabf\uaac1\uabe5\uabe8\uabed\udc00-\udfff\ufb1e\ufe00-\ufe0f\ufe20-\ufe26\uff9e\uff9f]/;
    function iB(a) {
    ...
    function iU(b, c, d) {
        ...
        a.lineSpace = gZ("div", [a.measure, a.lineMeasure, a.selectionDiv, a.cursorDiv, a.lineDiv], null, "position: relative; outline: none");
        a.mover = gZ("div", [gZ("div", [a.lineSpace], "CodeMirror-lines")], null, "position: relative");
        a.sizer = gZ("div", [a.mover], "CodeMirror-sizer");
        a.sizerWidth = null;
        a.heightForcer = gZ("div", null, null, "position: absolute; height: " + ko + "px; width: 1px;");
        a.gutters = gZ("div", null, "CodeMirror-gutters");
        a.lineGutter = null;
        a.scroller = gZ("div", [a.sizer, a.heightForcer, a.gutters], "CodeMirror-scroll");
        a.scroller.setAttribute("tabIndex", "-1");
        a.wrapper = gZ("div", [a.scrollbarFiller, a.gutterFiller, a.scroller], "CodeMirror");
        if (kj && kH < 8) {
    ...
    function hm(c, a) {
        a -= c.first;
        if (a < 0 || a >= c.size) {
            throw new Error("There is no line " + (a + c.first) + " in the document.")
        }
        var f = c;
        while (!f.lines) {
            for (var e = 0; ; ++e) {
    ...
    function nV(h, g, c) {
        ...
        if (h) {
            for (var e = 0; e < h.length; ++e) {
                ...
                if (j || a.from == g && d.type == "bookmark" && (!c || !a.marker.insertLeft)) {
    ...
    function oc(h, f, c) {
        ...
        if (h) {
            for (var e = 0; e < h.length; ++e) {
                ...
                if (g || a.from == f && d.type == "bookmark" && (!c || a.marker.insertLeft)) {
                    var j = a.from == null || (d.inclusiveLeft ? a.from <= f : a.from < f);
                    (b || (b = [])).push(new h7(d,j ? null : a.from - f,a.to == null ? null : a.to - f))
                }
            }
        }
        return b
    ...
    function gO(e, a) {
        var f = gN && e.markedSpans, b;
        if (f) {
            for (var c = void 0, d = 0; d < f.length; ++d) {
                c = f[d];
                if (c.marker.collapsed && (a ? c.from : c.to) == null && (!b || lW(b, c.marker) < 0)) {
                    b = c.marker
                }
            }
        }
    ...
    function jS(d, m, f, e, h) {
        ...
        if (l) {
            for (var j = 0; j < l.length; ++j) {
                ...
                if (c <= 0 && (k.marker.inclusiveRight && h.inclusiveLeft ? kI(b.to, f) >= 0 : kI(b.to, f) > 0) || c >= 0 && (k.marker.inclusiveRight && h.inclusiveLeft ? kI(b.from, e) <= 0 : kI(b.from, e) < 0)) {
                    return true
                }
            }
        }
    ...
    function lJ(a, e, c) {
        ...
        for (var b = void 0, d = 0; d < e.markedSpans.length; ++d) {
            b = e.markedSpans[d];
            if (b.marker.collapsed && !b.marker.widgetNode && b.from == c.to && (b.to == null || b.to != c.from) && (b.marker.inclusiveLeft || c.marker.inclusiveRight) && lJ(a, e, b)) {
                return true
            }
        }
    }
    ...
    function hl(b, a, d, c) {
        ...
        do {
            a += d
        } while (a > 0 && iB(b.text.charAt(a)));return a
    }
    function ka(f, a, g, e) {
        var d = ld(f);
        if (!d) {
    ...
    var mc = (function() {
        ...
        var g = "rrrrrrrrrrrr,rNNmmmmmmrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrmmmmmmmmmmmmmmrrrrrrrnnnnnnnnnn%nnrrrmrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrmmmmmmmmmmmmmmmmmmmNmmmm";
        function h(l) {
            if (l <= 247) {
                return e.charAt(l)
            } else {
    ...
    function lP(a) {
        ...
        var c = hk ? gZ("span", "\u200b") : gZ("span", "\u00a0", null, "display: inline-block; width: 1px; margin-right: -1px");
    ...
    ;
    var lv = window.getSelection ? function(b) {
        try {
    ...
    hU.prototype = {
        ...
        column: function() {
            if (this.lastColumnPos < this.start) {
                this.lastColumnValue = mV(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue);
                this.lastColumnPos = this.start
            }
            return this.lastColumnValue - (this.lineStart ? mV(this.string, this.lineStart, this.tabSize) : 0)
        },
        indentation: function() {
            return mV(this.string, null, this.tabSize) - (this.lineStart ? mV(this.string, this.lineStart, this.tabSize) : 0)
        },
    ...
    function ib(f, g, b, c) {
        var d = [f.state.modeGen]
          , e = {};
        j2(f, g.text, f.doc.mode, b, function(k, j) {
            return d.push(k, j)
        }, e, c);
        var h = function(j) {
            var l = f.state.overlays[j]
              , k = 1
              , m = 0;
            j2(f, g.text, l.mode, true, function(r, p) {
                var n = k;
                while (m < r) {
                    var q = d[k];
                    if (q > r) {
    ...
    function jG(e, d, a) {
        if (!d.styles || d.styles[0] != e.state.modeGen) {
            var c = kM(e, m5(d));
            var b = ib(e, d, d.text.length > e.options.maxHighlightLength ? nK(e.doc.mode, c) : c);
            d.stateAfter = c;
            d.styles = b.styles;
            if (b.classes) {
    ...
    function j4(c, f, j, k) {
        ...
        var e = c.doc, h = e.mode, l;
        f = i3(e, f);
        var a = hm(e, f.line)
          , m = kM(c, f.line, j);
        var b = new hU(a.text,c.options.tabSize), g;
        if (k) {
            g = []
        }
    ...
    function j2(e, c, l, p, k, n, m) {
        ...
        var h = 0
          , j = null;
        var d = new hU(c,e.options.tabSize), g;
    ...
    function j0(c, d) {
        ...
        if (mU) {
            ...
            if (/\bcm-tab\b/.test(b.className) || (b.querySelector && b.querySelector(".cm-tab"))) {
        ...
        if (!q.test(k)) {
            ...
            while (true) {
                ...
                if (d[0] == "\t") {
                    ...
                    if (d[0] == "\r" || d[0] == "\n") {
                        t = b.appendChild(gZ("span", d[0] == "\r" ? "\u240d" : "\u2424", "cm-invalidchar"));
            ...
            if (k == q) {
                ...
                for (var z = 0; z < o.length; ++z) {
                    ...
                    if (B.type == "bookmark" && y.from == q && B.widgetNode) {
                        ...
                        if (y.from <= q && (y.to == null || y.to > q || B.collapsed && y.to == q && y.from == q)) {
            ...
            while (true) {
                if (a) {
                    ...
                    if (!t) {
                        ...
                        A.addToken(A, r, s ? s + v : v, D, q + r.length == k ? m : "", g, c)
                    }
                    if (u >= b) {
                        a = a.slice(b - q);
                        q = b;
    ...
    function nw(a, c) {
        ...
        var e = Array.prototype.slice.call(arguments, 2), b;
        if (lG) {
    ...
    function jA(c) {
        var a = c.bgClass ? c.bgClass + " " + (c.line.bgClass || "") : c.line.bgClass;
        if (a) {
    ...
    function kA(b) {
        ...
        var a = b.textClass ? b.textClass + " " + (b.line.textClass || "") : b.line.textClass;
        b.text.className = a || ""
    }
    function jo(d, f, g, e) {
        if (f.gutter) {
        ...
        if (f.line.gutterClass) {
            var l = jd(f);
            f.gutterBackground = gZ("div", null, "CodeMirror-gutter-background " + f.line.gutterClass, ("left: " + (d.options.fixedGutter ? e.fixedPos : -e.gutterTotalWidth) + "px; width: " + (e.gutterTotalWidth) + "px"));
            l.insertBefore(f.gutterBackground, f.text)
        }
        var j = f.line.gutterMarkers;
        if (d.options.lineNumbers || j) {
            var c = jd(f);
            var h = f.gutter = gZ("div", null, "CodeMirror-gutter-wrapper", ("left: " + (d.options.fixedGutter ? e.fixedPos : -e.gutterTotalWidth) + "px"));
            ...
            if (d.options.lineNumbers && (!j || !j["CodeMirror-linenumbers"])) {
                f.lineNumber = h.appendChild(gZ("div", jF(d.options, g), "CodeMirror-linenumber CodeMirror-gutter-elt", ("left: " + (e.gutterLeft["CodeMirror-linenumbers"]) + "px; width: " + (d.display.lineNumInnerWidth) + "px")))
            }
            if (j) {
                for (var k = 0; k < d.options.gutters.length; ++k) {
                    ...
                    if (a) {
                        h.appendChild(gZ("div", [a], "CodeMirror-gutter-elt", ("left: " + (e.gutterLeft[b]) + "px; width: " + (e.gutterWidth[b]) + "px")))
                    }
                }
            }
        }
    ...
    function my(c, a) {
        for (var b = mb(a); b != c.wrapper; b = b.parentNode) {
            if (!b || (b.nodeType == 1 && b.getAttribute("cm-ignore-events") == "true") || (b.parentNode == c.sizer && b != c.mover)) {
                return true
            }
        }
    }
    ...
    function hw(b) {
        ...
        var a = window.getComputedStyle ? window.getComputedStyle(c) : c.currentStyle;
        var d = {
    ...
    function jT(c, e, b) {
        if (c.line == e) {
            return {
                map: c.measure.map,
                cache: c.measure.cache
            }
        }
        for (var d = 0; d < c.rest.length; d++) {
            if (c.rest[d] == e) {
                return {
                    map: c.measure.maps[d],
                    cache: c.measure.caches[d]
                }
            }
        }
    ...
    function n3(a, k, d) {
        ...
        for (var e = 0; e < a.length; e += 3) {
            ...
            if (j != null) {
                ...
                if (d == "right" && j == b - g) {
                    while (e < a.length - 3 && a[e + 3] == a[e + 4] && !a[e + 5].insertLeft) {
                        h = a[(e += 3) + 2];
                        c = "right"
                    }
                }
    ...
    function kL(g, s, d, k) {
        ...
        if (u.nodeType == 3) {
            for (var j = 0; j < 4; j++) {
                ...
                while (f.coverStart + m < f.coverEnd && iB(s.line.text.charAt(f.coverStart + m))) {
                    ++m
                }
    ...
    function kk(c, b) {
        if (!window.screen || screen.logicalXDPI == null || screen.logicalXDPI == screen.deviceXDPI || !n2(c)) {
            return b
        }
    ...
    function mX(e, r, m, c, d) {
        ...
        for (; ; ) {
            if (a ? p == x || p == ka(r, x, 1) : p - x <= 1) {
                ...
                var o = b == x ? t : l;
                var u = c - (b == x ? A : s);
                if (l && !a && !/\s/.test(r.text.charAt(b)) && u > 0 && b < r.text.length && B.view.measure.heights.length > 1) {
    ...
    function ho(g) {
        ...
        for (var a = b.gutters.firstChild, f = 0; a; a = a.nextSibling,
        ++f) {
    ...
    function mp(b) {
        ...
        var a = d && Math.max(5, b.display.scroller.clientWidth / kJ(b.display) - 3);
        return function(f) {
            if (il(b.doc, f)) {
                return 0
            }
    ...
    function kg(b, h, l, k) {
        ...
        var d, f, c = g.lineSpace.getBoundingClientRect();
        try {
            d = h.clientX - c.left;
            f = h.clientY - c.top
        } catch (h) {
        ...
        if (k && e.xRel == 1 && (a = hm(b.doc, e.line).text).length == e.ch) {
            ...
            e = lA(e.line, Math.max(0, Math.round((d - hw(b.display).left) / kJ(b.display)) - j))
        }
        return e
    }
    function iR(d, a) {
    ...
    function i9(c, j) {
        ...
        for (var f = 0; f < d.sel.ranges.length; f++) {
            ...
            if (b.from().line >= c.display.viewTo || b.to().line < c.display.viewFrom) {
                continue
            }
            var g = b.empty();
    ...
    function mE(d, c, e) {
        ...
        b.style.height = Math.max(0, a.bottom - a.top) * d.options.cursorHeight + "px";
        if (a.other) {
            var f = e.appendChild(gZ("div", "\u00a0", "CodeMirror-cursor CodeMirror-secondarycursor"));
            f.style.display = "";
    ...
    function ns(l, m, k) {
        ...
        function e(t, u, v, w) {
            ...
            u = Math.round(u);
            w = Math.round(w);
            q.appendChild(gZ("div", null, "CodeMirror-selected", ("position: absolute; left: " + t + "px;\n                             top: " + u + "px; width: " + (v == null ? b - t : v) + "px;\n                             height: " + (w - u) + "px")))
        }
        function p(y, w, t) {
            var x = hm(r, y);
            var v = x.text.length;
            ...
            iG(ld(x), w || 0, t == null ? v : t, function(B, C, I) {
                ...
                if (!z || E.bottom > z.bottom || E.bottom == z.bottom && E.right > z.right) {
                    z = E
                }
                if (D < n + 1) {
                    D = n
    ...
    function iE(e) {
        ...
        if (g.length != c.lineNumChars) {
            var a = c.measure.appendChild(gZ("div", [gZ("div", g)], "CodeMirror-linenumber CodeMirror-gutter-elt"));
    ...
    function k8(e, l) {
        ...
        if (a && !kc && !iL && kG != null) {
            if (b && n) {
                l4(e, Math.max(0, Math.min(f.scrollTop + b * kG, f.scrollHeight - f.clientHeight)))
            }
            nq(e, Math.max(0, Math.min(f.scrollLeft + a * kG, f.scrollWidth - f.clientWidth)));
            if (!b || (b && n)) {
                l7(l)
            }
            j.wheelStartX = null;
        ...
        if (iF < 20) {
            if (j.wheelStartX == null) {
                ...
                setTimeout(function() {
                    ...
                    var r = (q && j.wheelDY && q / j.wheelDY) || (s && j.wheelDX && s / j.wheelDX);
    ...
    function i7(d, e, c) {
        this.cm = c;
        var b = this.vert = gZ("div", [gZ("div", null, null, "min-width: 1px")], "CodeMirror-vscrollbar");
        var a = this.horiz = gZ("div", [gZ("div", null, null, "height: 100%; min-height: 1px")], "CodeMirror-hscrollbar");
        d(b);
        d(a);
    ...
    i7.prototype = n0({
        update: function(d) {
            ...
            if (e) {
                ...
                this.vert.firstChild.style.height = Math.max(0, d.scrollHeight - d.clientHeight + f) + "px"
            } else {
            ...
            if (b) {
                ...
                this.horiz.firstChild.style.width = (d.scrollWidth - d.clientWidth + c) + "px"
            } else {
    ...
    function hK(c, a) {
        ...
        nN(c, a);
        for (var b = 0; b < 4 && d != c.display.barWidth || e != c.display.barHeight; b++) {
    ...
    function nN(b, d) {
        ...
        if (c.bottom && b.options.coverGutterNextToScrollbar && b.options.fixedGutter) {
    ...
    function oa(a) {
        ...
        a.display.scrollbars = new lX[a.options.scrollbarStyle](function(b) {
    ...
    function iD(f, b) {
        ...
        if (b.top + e.top < 0) {
            ...
            if (b.bottom + e.top > (window.innerHeight || document.documentElement.clientHeight)) {
                d = false
            }
        }
        if (d != null && !iq) {
            var c = gZ("div", "\u200b", null, ("position: absolute;\n                         top: " + (b.top - a.viewOffset - hs(f.display)) + "px;\n                         height: " + (b.bottom - b.top + lh(f) + a.barHeight) + "px;\n                         left: " + (b.left) + "px; width: 2px;"));
    ...
    function mx(a, d, h, j) {
        ...
        for (var g = 0; g < 5; g++) {
            ...
            var k = mn(a, Math.min(b.left, c.left), Math.min(b.top, c.top) - j, Math.max(b.left, c.left), Math.max(b.bottom, c.bottom) + j);
    ...
    function mn(d, o, e, q, f) {
        ...
        var n = d.curOp && d.curOp.scrollTop != null ? d.curOp.scrollTop : j.scroller.scrollTop;
        var b = m8(d)
          , r = {};
        if (f - e > b) {
            f = e + b
        ...
        var a = d.curOp && d.curOp.scrollLeft != null ? d.curOp.scrollLeft : j.scroller.scrollLeft;
    ...
    function lM(a, b, c) {
        ...
        if (b != null) {
            a.curOp.scrollLeft = (a.curOp.scrollLeft == null ? a.doc.scrollLeft : a.curOp.scrollLeft) + b
        }
        if (c != null) {
            a.curOp.scrollTop = (a.curOp.scrollTop == null ? a.doc.scrollTop : a.curOp.scrollTop) + c
        }
    }
    function jl(b) {
        h2(b);
    ...
    function h2(c) {
        ...
        if (d) {
            ...
            var a = kw(c, d.from)
              , b = kw(c, d.to);
            var e = mn(c, Math.min(a.left, b.left), Math.min(a.top, b.top) - d.margin, Math.max(a.right, b.right), Math.max(a.bottom, b.bottom) + d.margin);
    ...
    function nH(b) {
        ...
        b.mustUpdate = b.viewChanged || b.forceUpdate || b.scrollTop != null || b.scrollToPos && (b.scrollToPos.from.line < c.viewFrom || b.scrollToPos.to.line >= c.viewTo) || c.maxLineChanged && a.options.lineWrapping;
        b.update = b.mustUpdate && new n4(a,b.mustUpdate && {
            top: b.scrollTop,
    ...
    function nP(b) {
        ...
        if (c.maxLineChanged && !a.options.lineWrapping) {
            ...
            b.barMeasure.scrollWidth = Math.max(c.scroller.clientWidth, c.sizer.offsetLeft + b.adjustWidthTo + lh(a) + a.display.barWidth);
            b.maxScrollLeft = Math.max(0, c.sizer.offsetLeft + b.adjustWidthTo - i4(a))
        }
    ...
    function m9(b) {
        ...
        var c = b.focus && b.focus == j3() && (!document.hasFocus || document.hasFocus());
    ...
    function hG(f) {
        ...
        if (d.wheelStartX != null && (f.scrollTop != null || f.scrollLeft != null || f.scrollToPos)) {
            d.wheelStartX = d.wheelStartY = null
        }
        if (f.scrollTop != null && (d.scroller.scrollTop != f.scrollTop || f.forceScroll)) {
            b.scrollTop = Math.max(0, Math.min(d.scroller.scrollHeight - d.scroller.clientHeight, f.scrollTop));
            d.scrollbars.setScrollTop(b.scrollTop);
            d.scroller.scrollTop = b.scrollTop
        }
        if (f.scrollLeft != null && (d.scroller.scrollLeft != f.scrollLeft || f.forceScroll)) {
            b.scrollLeft = Math.max(0, Math.min(d.scroller.scrollWidth - d.scroller.clientWidth, f.scrollLeft));
            d.scrollbars.setScrollLeft(b.scrollLeft);
            d.scroller.scrollLeft = b.scrollLeft;
            ja(a)
        }
        if (f.scrollToPos) {
            var c = mx(a, i3(b, f.scrollToPos.from), i3(b, f.scrollToPos.to), f.scrollToPos.margin);
    ...
    function np(c, e, d, b) {
        ...
        var h = c.display;
        if (b && d < h.viewTo && (h.updateLineNumbers == null || h.updateLineNumbers > e)) {
                ...
                if (e <= h.viewFrom && d >= h.viewTo) {
                    ...
                    if (e <= h.viewFrom) {
                        ...
                        if (d >= h.viewTo) {
                            ...
                            var j = jq(c, d, d + b, 1);
                            if (g && j) {
                                h.view = h.view.slice(0, g.index).concat(hQ(c, g.lineN, j.lineN)).concat(h.view.slice(j.index));
                                h.viewTo += b
                            } else {
                                jw(c)
                            }
    ...
    function jq(a, g, e, h) {
        var d = iR(a, g), b, c = a.display.view;
    ...
    function lu(c) {
        ...
        var e = [];
        a.iter(a.frontier, Math.min(a.first + a.size, c.display.viewTo + 500), function(h) {
            if (a.frontier >= c.display.viewFrom) {
                ...
                var k = !n || n.length != h.styles.length || f != m && (!f || !m || f.bgClass != m.bgClass || f.textClass != m.textClass);
    ...
    function mC(b, h) {
        ...
        if (!h.force && h.visible.from >= g.viewFrom && h.visible.to <= g.viewTo && (g.updateLineNumbers == null || g.updateLineNumbers >= g.viewTo) && g.renderedView == g.view && jv(b) == 0) {
            return false
        }
        if (iE(b)) {
            jw(b);
        ...
        var k = e != g.viewFrom || d != g.viewTo || g.lastWrapHeight != h.wrapperHeight || g.lastWrapWidth != h.wrapperWidth;
        lm(b, e, d);
        g.viewOffset = m7(hm(b.doc, g.viewFrom));
        b.display.mover.style.top = g.viewOffset + "px";
        var a = jv(b);
        if (!k && a == 0 && !h.force && g.renderedView == g.view && (g.updateLineNumbers == null || g.updateLineNumbers >= g.viewTo)) {
            return false
        }
        var f = j3();
        if (a > 4) {
    ...
    function kt(e, a) {
        ...
        for (var b = true; ; b = false) {
            if (!b || !e.options.lineWrapping || a.oldDisplayWidth == i4(e)) {
                if (c && c.top != null) {
                    c = {
                        top: Math.min(e.doc.height + ni(e.display) - m8(e), c.top)
                    }
                }
                a.visible = lc(e.display, e.doc, c);
                if (a.visible.from >= e.display.viewFrom && a.visible.to <= e.display.viewTo) {
                    break
                }
            }
            if (!mC(e, a)) {
    ...
    function kV(a, b) {
        ...
        a.display.gutters.style.height = (b.docHeight + a.display.barHeight + lh(a)) + "px"
    }
    function io(f) {
    ...
    function m1(a) {
        ...
        return lA(a.from.line + a.text.length - 1, ji(a.text).length + (a.text.length == 1 ? a.from.ch : 0))
    }
    function nS(b, c) {
        if (kI(b, c.from) < 0) {
            return b
    ...
    function lR(a, b) {
        return b.from.ch == 0 && b.to.ch == 0 && ji(b.text) == "" && (!a.cm || a.cm.options.wholeLineUpdateBefore)
    }
    function id(r, f, m, g) {
        function n(t) {
            return m ? m[t] : null
    ...
    function iX(d, f, a, g) {
        ...
        var j = +new Date, c;
        var b;
        if ((h.lastOp == g || h.lastOrigin == f.origin && f.origin && ((f.origin.charAt(0) == "+" && d.cm && h.lastModTime > j - d.cm.options.historyEventDelay) || f.origin.charAt(0) == "*")) && (c = kl(h, h.lastOp == g))) {
            b = ji(c.changes);
    ...
    function nx(a, c, d, b) {
        var e = c.charAt(0);
        return e == "*" || e == "+" && d.ranges.length == b.ranges.length && d.somethingSelected() == b.somethingSelected() && new Date - a.history.lastSelTime <= (a.cm ? a.cm.options.historyEventDelay : 500)
    }
    function hN(a, d, c, e) {
        var b = a.history
          , f = e && e.origin;
        if (c == b.lastSelOp || (f && b.lastSelOrigin == f && (b.lastModTime == b.lastSelTime && b.lastOrigin == f || nx(a, f, ji(b.done), d)))) {
    ...
    function jN(b, c, d) {
        if (iI(b, "beforeSelectionChange") || b.cm && iI(b.cm, "beforeSelectionChange")) {
            c = lb(b, c, d)
        }
        var a = d && d.bias || (kI(c.primary().head, b.sel.primary().head) < 0 ? -1 : 1);
        jD(b, kx(b, c, a, true));
        ...
        if (a.markedSpans) {
            for (var h = 0; h < a.markedSpans.length; ++h) {
                var m = a.markedSpans[h]
                  , l = m.marker;
                if ((m.from == null || (l.inclusiveLeft ? m.from <= d.ch : m.from < d.ch)) && (m.to == null || (l.inclusiveRight ? m.to >= d.ch : m.to > d.ch))) {
                    if (f) {
                    ...
                    if (j) {
                        ...
                        if (e && e.line == d.line && (c = kI(e, j)) && (k < 0 ? c < 0 : c > 0)) {
                            return iS(b, e, d, k, f)
                        }
                    }
    ...
    function mJ(b, a, e, g, d) {
        var f = g || 1;
        var c = iS(b, a, e, f, d) || (!d && iS(b, a, e, f, true)) || iS(b, a, e, -f, d) || (!d && iS(b, a, e, -f, true));
        if (!c) {
            b.cantEdit = true;
            return lA(b.first, 0)
        }
    ...
    function iC(d, b) {
        ...
        d.first += b;
        d.sel = new g0(mO(d.sel.ranges, function(e) {
            return new lz(lA(e.anchor.line + b, e.anchor.ch),lA(e.head.line + b, e.head.ch))
        }),d.sel.primIndex);
        if (d.cm) {
    ...
    ig.prototype = {
        ...
        removeInner: function(g, h) {
            ...
            if (this.size - h < 25 && (this.children.length > 1 || !(this.children[0]instanceof hH))) {
                var a = [];
                this.collapse(a);
        ...
        maybeSpill: function() {
            ...
            do {
                ...
                d.parent = c.parent
            } while (c.children.length > 10);c.parent.maybeSpill()
        },
    ...
    function i5(c, e, d, a, g) {
        ...
        if (h.collapsed) {
            if (jS(c, e.line, e, d, h) || e.line != d.line && jS(c, d.line, e, d, h)) {
        ...
        var k = e.line, f = c.cm, l;
        c.iter(k, d.line + 1, function(m) {
            if (f && h.collapsed && !f.options.lineWrapping && jV(m) == f.display.maxLine) {
                l = true
            }
    ...
    function kd(a) {
        return a.findMarks(lA(a.first, 0), a.clipPos(lA(a.lastLine())), function(b) {
            return b.parent
        })
    }
    function kC(b, a) {
    ...
    mT.prototype = ks(ig.prototype, {
        ...
        getHistory: function() {
            return {
                done: mZ(this.history.done),
                undone: mZ(this.history.undone)
            }
        },
        ...
        addLineClass: mg(function(b, c, a) {
            return jp(this, b, c == "gutter" ? "gutter" : "class", function(e) {
                var d = c == "text" ? "textClass" : c == "background" ? "bgClass" : c == "gutter" ? "gutterClass" : "wrapClass";
                if (!e[d]) {
                    e[d] = a
                } else {
                    if (lO(a).test(e[d])) {
            ...
            return jp(this, b, c == "gutter" ? "gutter" : "class", function(g) {
                ...
                if (!e) {
                    ...
                    if (a == null) {
                        ...
                        g[d] = e.slice(0, f.index) + (!f.index || h == e.length ? "" : " ") + e.slice(h) || null
                    }
                }
                return true
            })
        ...
        findMarksAt: function(a) {
            ...
            if (d) {
                for (var e = 0; e < d.length; ++e) {
                    var c = d[e];
                    if ((c.from == null || c.from <= a.ch) && (c.to == null || c.to >= a.ch)) {
        ...
        findMarks: function(a, c, e) {
            ...
            this.iter(a.line, c.line + 1, function(h) {
                ...
                if (f) {
                    for (var g = 0; g < f.length; g++) {
                        var j = f[g];
                        if (!(j.to != null && b == a.line && a.ch >= j.to || j.from == null && b != a.line || j.from != null && b == c.line && j.from >= c.ch) && (!e || e(j.marker))) {
        ...
        posFromIndex: function(b) {
            var d, a = this.first, c = this.lineSeparator().length;
        ...
        copy: function(a) {
            var b = new mT(gS(this, this.first, this.first + this.size),this.modeOption,this.first,this.lineSep);
        ...
        linkedDoc: function(b) {
            ...
            var d = new mT(gS(this, a, c),b.mode || this.modeOption,a,this.lineSep);
            if (b.sharedHist) {
    ...
    function l5(d) {
        ...
        if (l && l.length && window.FileReader && window.File) {
            var h = l.length
              ...
              , k = 0;
            var f = function(n, o) {
                if (b.options.allowDropFileTypes && jb(b.options.allowDropFileTypes, n.type) == -1) {
                    return
                }
    ...
    function hD(b, d) {
        ...
        if (!b.display.dragCursor) {
            b.display.dragCursor = gZ("div", null, "CodeMirror-cursors CodeMirror-dragcursors");
            b.display.lineSpace.insertBefore(b.display.dragCursor, b.display.cursorDiv)
        }
            ...
            return lI(a, function() {
                ...
                for (var d = 0; d < e.length; d++) {
                    ...
                    if (g) {
                        ...
                        if (b.ch > 0) {
                            b = new lA(b.line,b.ch + 1);
                            a.replaceRange(g.charAt(b.ch - 1) + g.charAt(b.ch - 2), lA(b.line, b.ch - 2), b, "+transpose")
                        } else {
                            if (b.line > a.doc.first) {
                                var c = hm(a.doc, b.line - 1).text;
                                if (c) {
                                    b = new lA(b.line,1);
                                    a.replaceRange(g.charAt(0) + a.doc.lineSeparator() + c.charAt(c.length - 1), lA(b.line - 1, c.length - 1), b, "+transpose")
                                }
                            }
                        }
                    }
        ...
        newlineAndIndent: function(a) {
            return lI(a, function() {
                ...
                for (var c = d.length - 1; c >= 0; c--) {
                    a.replaceRange(a.doc.lineSeparator(), d[c].anchor, d[c].head, "+input")
                }
                d = a.listSelections();
                for (var b = 0; b < d.length; b++) {
    ...
    function iy(d, c, a) {
        ...
        return (d.options.extraKeys && kN(c, d.options.extraKeys, a, d)) || kN(c, d.options.keyMap, a, d)
    }
    var j9 = new hA;
    function mr(f, d, a, b) {
    ...
    function iM(a, b) {
        ...
        if (b.shiftKey && !a.state.keySeq) {
            return mr(a, "Shift-" + c, b, function(d) {
                return he(a, d, true)
            }) || mr(a, c, b, function(d) {
    ...
    function kp(b) {
        ...
        if (d == 18 && !/\bCodeMirror-crosshair\b/.test(a.display.lineDiv.className)) {
            mY(a)
        }
    }
    function mY(c) {
    ...
    function mw(a) {
        var c = this;
        if (my(c.display, a) || nT(c, a) || a.ctrlKey && !a.altKey || k9 && a.metaKey) {
            return
        }
        var b = a.keyCode
          , e = a.charCode;
    ...
    function mK(h, b, a) {
        ...
        var c = h.doc.sel, f = k9 ? b.metaKey : b.ctrlKey, e;
        if (h.options.dragDrop && kr && !h.isReadOnly() && d == "single" && (e = c.contains(a)) > -1 && (kI((e = c.ranges[e]).from(), a) < 0 || a.xRel > 0) && (kI(e.to(), a) > 0 || a.xRel < 0)) {
            gR(h, b, a, f)
        } else {
            kB(h, b, a, d, f)
        }
    ...
    function gR(f, b, a, g) {
        ...
        var d = mQ(f, function(h) {
            ...
            if (Math.abs(b.clientX - h.clientX) + Math.abs(b.clientY - h.clientY) < 10) {
                l7(h);
                if (!g && +new Date - 200 < e) {
                    g5(f.doc, a)
                }
    ...
    function kB(m, t, n, p, k) {
        ...
        function c(B) {
            ...
            if (p == "rect") {
                ...
                var I = Math.min(K, x)
                  , z = Math.max(K, x);
                for (var w = Math.min(n.line, B.line), G = Math.min(m.lastLine(), Math.max(n.line, B.line)); w <= G; w++) {
                    var y = hm(r, w).text
                      , H = jM(y, I, E);
                    if (I == z) {
    ...
    function i0(a) {
        ...
        a.defineOption = c;
        a.Init = kQ;
        c("value", "", function(e, d) {
            return e.setValue(d)
        }, true);
        c("mode", null, function(e, d) {
            e.doc.modeOption = d;
            ly(e)
        }, true);
        ...
        c("specialChars", /[\u0000-\u001f\u007f\u00ad\u200b-\u200f\u2028\u2029\ufeff]/g, function(f, d, e) {
            f.state.specialChars = new RegExp(d.source + (d.test("\t") ? "" : "|\t"),"g");
            if (e != kQ) {
                f.refresh()
            }
        });
        c("specialCharPlaceholder", hn, function(d) {
            return d.refresh()
        }, true);
        c("electricChars", true);
        c("inputStyle", ie ? "contenteditable" : "textarea", function() {
            throw new Error("inputStyle can not (yet) be changed in a running editor")
        }, true);
        c("spellcheck", false, function(e, d) {
            return e.getInputField().spellcheck = d
        }, true);
        c("rtlMoveVisually", !nW);
        c("wholeLineUpdateBefore", true);
        c("theme", "default", function(d) {
            lC(d);
            k1(d)
        }, true);
        ...
        c("gutters", [], function(d) {
            kK(d.options);
            k1(d)
        }, true);
        c("fixedGutter", true, function(e, d) {
            e.display.gutters.style.left = d ? lw(e.display) + "px" : "0";
            e.refresh()
        }, true);
        c("coverGutterNextToScrollbar", false, function(d) {
            return hK(d)
        }, true);
        c("scrollbarStyle", "native", function(d) {
            oa(d);
            hK(d);
            d.display.scrollbars.setScrollTop(d.doc.scrollTop);
            d.display.scrollbars.setScrollLeft(d.doc.scrollLeft)
        }, true);
        c("lineNumbers", false, function(d) {
            kK(d.options);
            k1(d)
        }, true);
        c("firstLineNumber", 1, k1, true);
        c("lineNumberFormatter", function(d) {
            return d
        }, k1, true);
        ...
        c("disableInput", false, function(e, d) {
            if (!d) {
        ...
        c("viewportMargin", 10, function(d) {
            return d.refresh()
        }, true);
    ...
    function hx(g, e) {
        ...
        ng(this);
        if (mU && e.lineWrapping && getComputedStyle(b.lineDiv).textRendering == "optimizelegibility") {
    ...
    function hf(h) {
        ...
        if (kj && kH < 11) {
            nY(c.scroller, "dblclick", mQ(h, function(k) {
                if (nT(h, k)) {
                    return
                }
                var j = kg(h, k);
        ...
        nY(c.scroller, "touchend", function(l) {
            var j = c.activeTouch;
            if (j && !my(c, l) && j.left != null && !j.moved && new Date - j.start < 300) {
                var k = h.coordsChar(c.activeTouch, "page"), m;
            ...
            if (q.empty()) {
                if (m && m > 0) {
                    ...
                    if (a.state.overwrite && !l) {
                        e = lA(e.line, Math.min(hm(c, e.line).text.length, e.ch + ji(h).length))
                    } else {
    ...
    function g7(g, d) {
        ...
        for (var e = c.ranges.length - 1; e >= 0; e--) {
            ...
            if (b.electricChars) {
                ...
                if (b.electricInput) {
                    if (b.electricInput.test(hm(g.doc, a.head.line).text.slice(0, a.head.ch))) {
                        h = nz(g, a.head.line, "smart")
                    }
                }
            }
    ...
    function nG() {
        var a = gZ("textarea", null, null, "position: absolute; bottom: -1em; padding: 0; width: 1px; height: 1em; outline: none");
        var b = gZ("div", [a], null, "overflow: hidden; position: relative; width: 3px; height: 0px;");
        if (mU) {
        ...
        a.prototype = {
            ...
            heightAtLine: function(g, j, d) {
                ...
                return j8(this, f, {
                    top: 0,
                    left: 0
                }, j || "page", d).top + (h ? this.doc.height - m7(f) : 0)
            },
            ...
            addWidget: function(h, l, f, k, d) {
                ...
                if (k == "over") {
                    ...
                    if (k == "above" || k == "near") {
                        ...
                        if ((k == "above" || h.bottom + l.offsetHeight > n) && h.top > l.offsetHeight) {
            ...
            scrollIntoView: jC(function(d, e) {
                ...
                if (d.from.line != null) {
                    ...
                    var f = mn(this, Math.min(d.from.left, d.to.left), Math.min(d.from.top, d.to.top) - d.margin, Math.max(d.from.right, d.to.right), Math.max(d.from.bottom, d.to.bottom) + d.margin);
    ...
    function lB(b, g, k, c) {
        var d = b.doc, e = g.left, f;
        if (c == "page") {
            var h = Math.min(b.display.wrapper.clientHeight, window.innerHeight || document.documentElement.clientHeight);
    ...
    k7.prototype = n0({
        ...
        showPrimarySelection: function() {
            ...
            if (j && !j.bad && e && !e.bad && kI(m3(j, e), g.from()) == 0 && kI(nD(j, e), g.to()) == 0) {
                return
            }
        ...
        pollContent: function() {
            ...
            var h = ji(s)
              , r = ji(b);
            var n = Math.min(h.length - (s.length == 1 ? x : 0), r.length - (b.length == 1 ? x : 0));
            while (o < n && h.charCodeAt(h.length - o - 1) == r.charCodeAt(r.length - o - 1)) {
                ++o
            }
        ...
        onKeyPress: function(a) {
            ...
            if (!this.cm.isReadOnly()) {
                mQ(this.cm, g4)(this.cm, String.fromCharCode(a.charCode == null ? a.keyCode : a.charCode), 0)
            }
        },
    ...
    function g3(c, e, d, h, k) {
        ...
        function f(o) {
            if (o.nodeType == 1) {
                ...
                var p = o.getAttribute("cm-marker"), l;
                if (p) {
    ...
    function li(h, m, k) {
        ...
        for (var g = c.nextSibling, f = l ? l.nodeValue.length - k : 0; g; g = g.nextSibling) {
    ...
    lt.prototype = n0({
        ...
        prepareSelection: function() {
            ...
            if (g.options.moveInputWithCursor) {
                ...
                e.teTop = Math.max(0, Math.min(b.wrapper.clientHeight - 10, a.top + d.top - f.top));
                e.teLeft = Math.max(0, Math.min(b.wrapper.clientWidth - 10, a.left + d.left - f.left))
            }
            return e
        },
        ...
        reset: function(e) {
            ...
            var g, f, d = this.cm, b = d.doc;
            if (d.somethingSelected()) {
                this.prevInput = "";
                var a = b.sel.primary();
                g = jz && (a.to().line - a.from().line > 100 || (f = d.getSelection()).length > 1000);
        ...
        focus: function() {
            if (this.cm.options.readOnly != "nocursor" && (!ie || j3() != this.textarea)) {
                try {
                    this.textarea.focus()
                } catch (a) {}
            }
        ...
        poll: function() {
            ...
            var f = this.cm
              , g = this.textarea
              , e = this.prevInput;
            if (this.contextMenuPending || !f.state.focused || (lv(g) && !e && !this.composing) || f.isReadOnly() || f.options.disableInput || f.state.keySeq) {
                return false
            }
            var c = g.value;
            ...
            if (kj && kH >= 9 && this.hasSelection === c || k9 && /[\uf700-\uf7ff]/.test(c)) {
                f.display.input.reset();
                return false
            }
            ...
            lI(f, function() {
                g4(f, c.slice(b), e.length - b, null, a.composing ? "*compose" : null);
                ...
                if (a.composing) {
                    ...
                    a.composing.range = f.markText(a.composing.start, f.getCursor("to"), {
                        className: "CodeMirror-composing"
                    })
                }
            });
        ...
        onContextMenu: function(l) {
            ...
            function h() {
                ...
                if (p.selectionStart != null) {
                    ...
                    var r = 0
                      , q = function() {
                        if (j.selForContextMenu == d.doc.sel && p.selectionStart == 0 && p.selectionEnd > 0 && e.prevInput == "\u200b") {
                            mQ(d, nh)(d)
                        } else {
                            if (r++ < 10) {
    ...
    function je(c, b) {
        ...
        if (b.autofocus == null) {
            var a = j3();
            b.autofocus = a == c || c.getAttribute("autofocus") != null && a == document.body
        }
        function f() {
            c.value = d.getValue()
        }
